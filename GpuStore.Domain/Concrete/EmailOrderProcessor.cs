...
namespace GpuStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "gpustore@example.com";
        ...
        public string FileLocation = @"C:\Petr\ASP.NET";
    }
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Card.Price * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2:c}",
                        line.Quantity, line.Card.Name, subtotal);
                }
